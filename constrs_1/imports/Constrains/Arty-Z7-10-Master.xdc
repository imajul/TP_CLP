...
#set_output_delay -clock [get_clocks clk_i] -min -add_delay -2.000 [get_ports tx_pin]
#set_output_delay -clock [get_clocks clk_i] -max -add_delay -2.000 [get_ports tx_pin]




set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pos_o[0]}]
set_property PACKAGE_PIN Y18 [get_ports {pos_o[0]}]
set_property PACKAGE_PIN Y19 [get_ports {pos_o[1]}]
set_property PACKAGE_PIN Y16 [get_ports {pos_o[2]}]
set_property PACKAGE_PIN Y17 [get_ports {pos_o[3]}]
set_property PACKAGE_PIN U18 [get_ports {pos_o[4]}]
set_property PACKAGE_PIN U19 [get_ports {pos_o[5]}]
set_property PACKAGE_PIN W18 [get_ports {pos_o[6]}]
set_property PACKAGE_PIN W19 [get_ports {pos_o[7]}]
set_property PULLDOWN true [get_ports {pos_o[7]}]
set_property PULLDOWN true [get_ports {pos_o[6]}]
set_property PULLDOWN true [get_ports {pos_o[5]}]
set_property PULLDOWN true [get_ports {pos_o[4]}]
set_property PULLDOWN true [get_ports {pos_o[3]}]
set_property PULLDOWN true [get_ports {pos_o[2]}]
set_property PULLDOWN true [get_ports {pos_o[1]}]
set_property PULLDOWN true [get_ports {pos_o[0]}]

set_property PACKAGE_PIN T10 [get_ports dir_o]
set_property IOSTANDARD LVCMOS33 [get_ports dir_o]

create_clock -period 20.000 -name clk_i -waveform {0.000 10.000} [get_ports clk_i]
set_input_delay -clock [get_clocks clk_i] -min -add_delay -0.500 [get_ports channel_A_i]
set_input_delay -clock [get_clocks clk_i] -max -add_delay 0.000 [get_ports channel_A_i]
set_input_delay -clock [get_clocks clk_i] -min -add_delay -0.500 [get_ports channel_B_i]
set_input_delay -clock [get_clocks clk_i] -max -add_delay 0.000 [get_ports channel_B_i]
set_input_delay -clock [get_clocks clk_i] -clock_fall -min -add_delay -0.500 [get_ports rst_i]
set_input_delay -clock [get_clocks clk_i] -clock_fall -max -add_delay 0.000 [get_ports rst_i]


#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[0]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[1]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[2]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[3]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[4]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[5]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[6]}]
#set_property MARK_DEBUG true [get_nets {pos_o_OBUF[7]}]
...
##connect_debug_port u_ila_0/probe0 [get_nets [list {pos_o_OBUF[0]} {pos_o_OBUF[1]} {pos_o_OBUF[2]} {pos_o_OBUF[3]} {pos_o_OBUF[4]} {pos_o_OBUF[5]} {pos_o_OBUF[6]} {pos_o_OBUF[7]}]]
